...
- **PR-uri deschise:** #247 (merged 09-04 prin REBASE — git nu-l poate dovedi; `sync_state.py`
  il da acum ca „nu pot decide"). Owner: #207 #214 #235. Serie 09-04 de ceilalti agenti,
  cu garda lor din #264: #262 (merged 09-05), #263 (merged 09-05), #264 deschis, #265
  inchis, #266 (merged 09-05), #267 inchis, #268-#270 si #277 inca deschise (#271-#276
  nu exista).
...
- **PLASA pentru restructurare (`IZZ-0271`)**: `tools/echivalenta.py` amprenteaza `output/`;
  ...
  `set` iterat x2 + `sum` pe float, neasociativ), reparat in #254 (merged 09-04, rebase — git nu-l poate dovedi). Cuplarea reala nu e prin importuri — `specs/arhitectura-cuplare.md`, NU re-cerceta.
