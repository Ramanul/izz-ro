#!/usr/bin/env python
"""Generează liste separate pentru primării pe categorii de funcționalitate."""
import csv
import sys
...
INPUT_CSV = "data/primarii_status.csv"
OUTPUT_DIR = "data/primarii_lists"
...
CATEGORIES = {
    ...
    "real_primarie": lambda r: r["is_primarie"] == "yes",
    "unclear_primarie": lambda r: r["is_primarie"] == "unclear",
}
...
def main():
    ...
    print(f"Total primării: {len(rows)}")
