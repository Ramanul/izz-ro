...
ARTICLE_TTL_DAYS (21), si asta a fost citit de mai multe ori ca „pipeline-ul isi
sterge arhiva zilnic, ireversibil". Nu e adevarat in repo-ul asta: `articles.json`
e COMIS la fiecare rulare (~2h), iar un articol traieste trei saptamani — deci apuca
