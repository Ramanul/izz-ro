...
ARTICLE_TTL_DAYS (20), si asta a fost citit de mai multe ori ca „pipeline-ul isi
sterge arhiva zilnic, ireversibil". Nu e adevarat in repo-ul asta: `articles.json`
e COMIS la fiecare rulare (~2h), iar un articol traieste douazeci de zile — deci apuca
sa fie comis de sute de ori inainte sa expire. Masurat 2026-08-04 pe 265 de commituri:
