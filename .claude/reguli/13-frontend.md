...
> **Regulă L1.** Nu stă în `CLAUDE.md` fiindcă se aplică doar când atingi front-end-ul; hook-ul
> `PostToolUse` o livrează atunci, o dată pe sesiune. Numele „§13" e păstrat deliberat: e citat
> în `.claude/commands/`, în agenți și în jurnale, iar redenumirea ar rupe trimiterile.
