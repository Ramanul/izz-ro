...
- **Current baseline — re-measured 2026-08-02 on `main` @ `3ae6862`, 5 consecutive runs per page:** home Perf **80** / A11y 100 / BP 100 / SEO 100; article Perf **88** / 100 / 100 / 100; pa11y WCAG2AA **0** errors. Perf was identical in all 5 runs (home 80×5, article 88×5); one `audit.sh` run under different machine load read home 84, so **treat a single-run Perf delta under ~5 points as noise** — re-run before calling it a regression.
