"""Gărzi pentru prima felie România Utilă: datele volatile trebuie să fie verificabile și actuale."""
...
def test_salarii_si_alocatii_sunt_verificate_pentru_2026():
    ...
    assert salariu["ultima_verificare"] == "2026-09-04"
    ...
    assert alocatie["ultima_verificare"] == "2026-09-04"
...
def test_calendarul_anaf_are_termenele_curente_si_sursa_oficiala():
    ...
    assert ent["valoare_curenta"]["sursa_url"].startswith("https://static.anaf.ro/")
